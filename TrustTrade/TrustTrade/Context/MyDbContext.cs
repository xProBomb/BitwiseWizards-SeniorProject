...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<InvestmentPosition>(entity =>
        {
            ...
            entity.HasOne(d => d.PlaidConnection).WithMany(p => p.InvestmentPositions).HasConstraintName("FK_InvestmentPositions_PlaidConnection");
        });
        ...
        modelBuilder.Entity<PlaidConnection>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.PlaidConnections).HasConstraintName("FK_PlaidConnections_User");
        });
